...
const QuestionId = ({ navigation, route }: { navigation: NavigationProp<any>, route: any }) => {
    ...
    return (
        <View style={styles.questionWrap}>
            ...
            <View style={styles.radioBtn_ID}>
                <RadioButton.Group onValueChange={newValue => setValue(newValue)} value={value}>
                    <View style={styles.radioText}>
                        <RadioButton value="Hispanic" /><Text>Hispanic origin</Text>
                    </View>
                    <View style={styles.radioText}>
                        <RadioButton value="Non-hispanic" /><Text>Non-hispanic origin</Text>
                    </View>
                </RadioButton.Group>
            ...
            <View style={styles.questionProgress} >
                <View><Text style={{ textAlign: 'right' }}>Completed &nbsp; 99%</Text></View>
                <View style={{ width: '100%', flexDirection: "row" }}><Progress.Bar style={{ display: 'flex' }} progress={0.99} color='#7BC67E' height={12} /></View>
            </View>
